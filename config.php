...
return [
    ...
    'responsible' => env_value('SITE_RESPONSIBLE', 'Eliesio José da Rocha'),
    ...
    'privacy_officer_name' => env_value('SITE_PRIVACY_OFFICER_NAME', 'Elane Campos Maciel'),
    'privacy_officer_email' => env_value('SITE_PRIVACY_OFFICER_EMAIL', 'cartoriounicoanisio@outlook.com'),
    'base_url' => env_value('APP_URL', ''),
    'mail_enabled' => filter_var(env_value('MAIL_ENABLED', 'false'), FILTER_VALIDATE_BOOL),
    'mail_to' => env_value('MAIL_TO', 'cartoriounicoanisio@outlook.com'),
